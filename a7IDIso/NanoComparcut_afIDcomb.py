...
def RecoHWWCandidateSelection(df):
    ...
    if fiducial=="on":
        ...
        df=df.Filter("mindRGenlepFatjet>0.2", "mindR(Genlep, Fatjets)>0.2")
...
#################################################Ele after ID: 
    cuts = [
    f"{mychfull}_pfRelIso03_all.at(RecoLepIdx)<0.4",
    f"{mychfull}_pfRelIso03_all.at(RecoLepIdx)<0.25",
    f"{mychfull}_pfRelIso03_all.at(RecoLepIdx)<0.2",
    f"{mychfull}_pfRelIso03_all.at(RecoLepIdx)<0.15",
    f"{mychfull}_miniPFRelIso_all.at(RecoLepIdx)<0.4",
    f"{mychfull}_miniPFRelIso_all.at(RecoLepIdx)<0.25",
    f"{mychfull}_miniPFRelIso_all.at(RecoLepIdx)<0.2",
    f"{mychfull}_miniPFRelIso_all.at(RecoLepIdx)<0.15",
]
...
#     ]
    ...
    df = df.Filter(f"{mychfull}_mvaNoIso_WP90.at(RecoLepIdx)", "")
