...
def main(mychannel, var, hist_type):
    ...
    if hist_type =="genParticleDistribution": 
            canvas.SaveAs(f"plots/Gen{particle}_{var}_Combine_{mychannel}.png")
    if hist_type == "mindR_GenLepJet":
...
######################################################################def of processing genParticleDistribution hist
